...
namespace Burme_Burger
{
...

    {
        ...
        private Color[] colors = { Color.DarkGreen, Color.LightCoral, Color.Gold, Color.RoyalBlue, Color.DarkOrange }; // Renkler
        ...
        public FormHesap(List<(string ProductName, int Quantity, decimal Price)> siparisListesi = null)
        {
            ...
            colorTimer.Tick += colorChangeTimer_Tick_1;
        }
        ...
        private void colorChangeTimer_Tick_1(object sender, EventArgs e)
        {
